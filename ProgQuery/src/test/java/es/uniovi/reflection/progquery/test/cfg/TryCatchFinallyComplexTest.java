package es.uniovi.reflection.progquery.test.cfg;

import es.uniovi.reflection.progquery.database.querys.eval.MainQuery;
import es.uniovi.reflection.progquery.test.PluginBasedTestWithCommands;
