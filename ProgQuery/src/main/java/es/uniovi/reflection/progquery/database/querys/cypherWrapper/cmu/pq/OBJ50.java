...
import es.uniovi.reflection.progquery.database.querys.cypherWrapper.Case;
...
public class OBJ50 extends AbstractQuery {
	...
	public OBJ50(boolean isProgQuery) {
		super(isProgQuery);
	...
	public static void main(String[] args) {
		System.out.println(new OBJ50(true).queryToString());
	}

	@Override
	protected void initiate() {
		clauses = new Clause[] { DECLARED_TYPES_AND_DECLARED_FIELDS[0], DECLARED_TYPES_AND_DECLARED_FIELDS[1],
				new SimpleWithClause("attr", "declaringType", "typeDec"),
