...
public class CMUQueries {
	...
	// LO �NICO QUE ME MOSQUEA AHORA ES ESE OR DEL FINAL, PORQUE NO PERMITE
	// COSAS COMO
	/*
	 * if(){
	 * 
	 ...
	 * for() { Sysout(a) a=b; }
	 * 
	 * Y LOS ATRIBUTOS NO PUEDEN SER P�BLICOS DE CLASES P�BLICAS, PORQUE
	...
	// Object:clone<-ov-method_clone SE necesita comprobaci�n super.clone
