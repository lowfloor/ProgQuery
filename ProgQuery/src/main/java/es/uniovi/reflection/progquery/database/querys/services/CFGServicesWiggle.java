...
import es.uniovi.reflection.progquery.database.querys.cypherWrapper.MultipleClauses;
		...
		return new MultipleClauses(
				new MatchClause(new Path(
						...
						Pair.create(new EdgeImpl(EdgeDirection.OUTGOING, RelationTypesWiggle.HAS_METHODDECL_BODY),
								es.uniovi.reflection.progquery.database.querys.cypherWrapper.Node.nodeForWiggle(NodeTypes.METHOD_DEF)))),
