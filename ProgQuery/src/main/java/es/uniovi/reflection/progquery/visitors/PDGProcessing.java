...
public class PDGProcessing {
	...
	private void addRels(Symbol s, NodeWrapper node, Object ASTVisitorParam, NodeWrapper currentClassDec,
		 ...
		 * PDGRelationTypes.USED_BY) { // SI LA RELACI�N NO ES USED BY---> HAY
		 * QUE A�ADIR PRIMERO // LA RELACI�N STATE_MOD_BY (SOLO LAS the this
		 * implicito, // para no duplicar) y la de // metodo, sacar de donde
		 * co�o esta super acoplada.... // preguntando lo mismo..., // donde se
		 * est� a�adiendo la otra?? la de A a; // a.a=2; en el ast visitor if
