...
//		NodeUtils.nodeToString(t.getFirst().getStartingNode());
	...
	public ASTVisitorResult visitVariable(VariableTree variableTree, Pair<PartialRelation<RelationTypes>, Object> t) {
		/*
		 * 
		 * 1� buscar los scans en este metodo u otros que llame, init o algo as�
		 * 2� asegurarse de que el tipo no se visita 3� visitarlo (con el de
		 * tipos) y usar el retorno de NodeWrapper tipo parametrizered type 4�
