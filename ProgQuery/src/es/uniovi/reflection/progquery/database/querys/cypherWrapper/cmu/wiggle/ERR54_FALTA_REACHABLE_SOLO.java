...
public class ERR54_FALTA_REACHABLE_SOLO extends AbstractQuery {
	...
	public ERR54_FALTA_REACHABLE_SOLO() {
		super(false);
	}
...
new SimpleWithClause(
		" DISTINCT autocloseableTypeNames,sucessors,mThrowsInfo,"+
		"stat,REDUCE(s=[], x IN EXTRACT(invSignature IN invInfoInStats | "
...
, 
				new SimpleWithClause(
						"DISTINCT "
						+ "autocloseableTypeNames,sucessors,"
						+ " FILTER(x IN COLLECT( [stat,throws]) WHERE NOT x[1] IS NULL) as statsMayThrow"),
			new MatchClause(true,
						"(stat)-[:THROW_EXPR]->(throwExpr)  WITH DISTINCT autocloseableTypeNames,sucessors, statsMayThrow+COLLECT([stat,throwExpr.actualType]) as statsMayThrow"),
				new MatchClause(true,
				...
				new SimpleWithClause("autocloseableTypeNames,sucessors,statsMayThrow ,id, varDec, varDec.actualType IN autocloseableTypeNames as isVarClos"),
...
//						" sucessors,"+
	...
	public static void main(String[] args) {
		System.out.println(new ERR54_FALTA_REACHABLE_SOLO().queryToString());
	}
}
