...
public class MainQuery {
	...
	/**
	 * Aqu� te paso consultas que modelan algunas reglas sencillas
	 **/
	// Un metodo que retorne una colecci�n o un array, debe retornal colecci�n
	// o array vaci�n en lugar de null
...
;
	// Se llama a clone en un m�todo publico de clase publica, y sobre un
	// par�metro cuya clase es p�blica y no est� marcada como final
	// Hay riesgo de que te llegue un par�metro de un cliente maligno que haya
	// extendido la clase del par�metro de modo que al clonarlo tenga un
